            ...
            <div>
              ...
              >
                ...
                <div className="text-gray-600">
                  <p className="font-medium">Click to upload or drag photos</p>
                  <p className="text-sm text-gray-500 mt-1">PNG, JPG, GIF up to 5MB per file</p>
                  {formData.images.length > 0 && (
                    <p className="text-sm text-pink-600 mt-2">{formData.images.length} image(s) selected</p>
                  )}
                </div>
              </div>
            </div>
